...
***apr/03/2026***
*Linux Mint 22.3 Zena, Kernel 6.17-19, Ubuntu 24.04 noble*
*Purpose: To contain setup and avoid installing too dependencies.*
[Official Instruciton](https://docs.docker.com/engine/install/ubuntu/#install-using-the-repository)
...
2. Install the Docker packages.
   ...
   **Specific version**
   ...
   docker-ce/noble 5:29.3.0-1~ubuntu.24.04~noble <arch>
